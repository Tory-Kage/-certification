...
2. Блок-схема алгоритма (основана на псевдокоде): ![Увы.. что-то пошло не так](schema.PNG)
3. Снабдил репозиторий оформленным текстовым описанием решения (файл README.md)
4. Написал программу.
5. При решении данной задачи были выполнены последовательно сделанные коммиты: ![Увы.. что-то пошло не так](Commits.png)
